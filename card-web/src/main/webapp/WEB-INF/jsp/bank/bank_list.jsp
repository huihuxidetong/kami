...
<body class="no-skin">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.bank_contacts_name}</td>
											<td class='center'>${var.bank_contacts_tel}</td>
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<c:if test="${QX.edit == 1 }">
														<a class="btn btn-mini btn-success" onclick="credits(${var.id});">信用卡</a>
													</c:if>
												</div>
	...
	<script type="text/javascript">
        ...
        //新增
        function add() {
            window.location.href="<%=basePath%>bank/goAdd.do";
        }
        //编辑
        function edit(id){
            window.location.href="<%=basePath%>bank/goEdit.do?id="+id;
        }
        //详情
        function detail(id) {
            window.location.href="<%=basePath%>bank/goDetail.do?id="+id;
        }
        //信用卡
        function credits(id) {
            window.location.href="<%=basePath%>bank/goNowCredit.do?bank_id="+id;
        }
		//删除
		function del(id){
