	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<div class="control-group">
					<div class="main_input_box">
						<font color="white"><span id="nameerr"><a style="color:#fff;" href="http://www.miitbeian.gov.cn">沪ICP备18017041号-1</a></span></font>
					</div>
				</div>
			</form>
		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_ly">
							<i>重输</i>
							</span><input type="password" name="chkpwd" id="chkpwd" placeholder="请重新输入密码"  keypadMode="full" allowKeyboard="true" value=""/>
						</div>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg">
							<i>手机</i>
							</span><input type="text" name="PHONE" id="PHONE" value="" maxlength="11" placeholder="请输入手机号" />
						</div>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="controls" style="padding:30px 0;">
					<div class="main_input_box">
						<font color="white"><span id="nameerr"><a style="color:#fff;" href="http://www.miitbeian.gov.cn">沪ICP备18017041号-1</a></span></font>
					</div>
				</div>
	...
	function register(){
		if(rcheck()){
			...
			$.ajax({
		    	...
		    	data: {PHONE:$("#PHONE").val(),USERNAME:$("#USERNAME").val(),PASSWORD:$("#PASSWORD").val(),NAME:$("#name").val(),EMAIL:$("#EMAIL").val(),rcode:$("#rcode").val(),FKEY:$.md5('USERNAME'+nowtime+',fh,'),tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					if("00" == data.result){
