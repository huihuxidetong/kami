...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">banner路径或链接</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class="center"><img alt=""  style="height:50px;width:100px;"  src="${var.banner_image}"/></td>
											<td class='center'>${var.banner_url}</td>
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<c:if test="${QX.del == 1 }">
														<a class="btn btn-mini btn-success" onclick="del(${var.id})">删除</a>
													</c:if>
												</div>
	...
	<script type="text/javascript">
		...
		//添加
		function add() {
            window.location.href="<%=basePath%>banner/goAdd.do";
        }
        //编辑
        function edit(id){
            window.location.href="<%=basePath%>banner/goEdit.do?id="+id;
        }
		//删除
		function del(id){
